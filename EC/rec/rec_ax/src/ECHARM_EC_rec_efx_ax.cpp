//
//  ECHARM_EC_rec_efx_ax.cpp
//
//
//  Created by Enrico Bagli on 04/06/12.
//  Copyright 2012 Enrico Bagli. All rights reserved.
//
#ifdef _ECHARM_EC_rec_efx_ax_h

#include "ECHARM_EC_rec_efx_ax.hh"

ECHARM_EC_rec_efx_ax::ECHARM_EC_rec_efx_ax(ECHARM_crystal* crystal,
                                           int recX,
                                           int recY):
ECHARM_EC_rec_efx(crystal,
                  recX,
                  recY,
                  0){
}
...
ECHARM_EC_rec_efx_ax::~ECHARM_EC_rec_efx_ax(){
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

bool ECHARM_EC_rec_efx_ax::GetIndexesSF(int* vIndex,int i0,int i1,int){
...
bool ECHARM_EC_rec_efx_ax::GetIndexesEC(double* vIndexEC,int* vIndexSF,int i0,int i1,int){
    if(fCrystal->GetMiller()->IsMainAxis()){
        vIndexEC[0] = i0;
        vIndexEC[1] = i1;
        return true;
