...
ECHARM_STAX110::ECHARM_STAX110(){
    ...
    fDim = new ECHARM_3vec(1.97 * millimeter,55. * millimeter,1.88 * millimeter);;
    fBRconst = new ECHARM_3vec(34.8 * meter,0.,0.);
