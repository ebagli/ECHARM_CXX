...
ECHARM_PL01::ECHARM_PL01(double Temp){
    //standard 420
    ...
    fDim = new ECHARM_3vec(0.52 * millimeter,55. * millimeter,20. * millimeter);;
    fBRconst = new ECHARM_3vec(68.97 * meter,0.,0.);
