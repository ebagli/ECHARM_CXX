...
///
///   Class ECHARM_crystal_SiO2 is a class derived from ECHARM_atom because it has all its characteristics averaged over the all the atom kind of the crystal.
///   It is really important to check that the ECHARM_crystal_SiO2 is ok before procede with any calculation method of this class.
...
///   has to be filled with Miller vIndexes of the plane and axis on which the ECHARM_crystal_SiO2 class will average electric characteristic.
...
#ifndef _ECHARM_crystal_SiO2_h
#define _ECHARM_crystal_SiO2_h

#include "ECHARM_crystal.hh"

class ECHARM_crystal_SiO2: public ECHARM_crystal
{
public:
    ECHARM_crystal_SiO2();
    virtual ~ECHARM_crystal_SiO2();
};
