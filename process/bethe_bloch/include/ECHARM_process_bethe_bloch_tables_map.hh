...
{
public:
    ECHARM_process_bethe_bloch_tables();
...
protected:
    std::map< int , std::vector<float> > fValueMap_dEdX_eld;
    std::map< int , std::vector<float> > fValueMap_dE;
    std::map< int , std::vector<float> > fValueMap_dEdX_nud;
