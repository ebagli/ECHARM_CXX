...
///
///   Class ECHARM_crystal_PbWO4_O is a class derived from ECHARM_atom because it has all its characteristics averaged over the all the atom kind of the crystal.
///   It is really important to check that the ECHARM_crystal_PbWO4_O is ok before procede with any calculation method of this class.
...
///   has to be filled with Miller vIndexes of the plane and axis on which the ECHARM_crystal_PbWO4_O class will average electric characteristic.
...
#ifndef _ECHARM_crystal_PbWO4_O_h
#define _ECHARM_crystal_PbWO4_O_h

#include "ECHARM_crystal.hh"

class ECHARM_crystal_PbWO4_O: public ECHARM_crystal
{
public:
    ECHARM_crystal_PbWO4_O();
    virtual ~ECHARM_crystal_PbWO4_O();
};
