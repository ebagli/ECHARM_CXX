...
ECHARM_StripPbWO4::ECHARM_StripPbWO4(int h,int k,int l){
    //standard 420
    
    fCrystal = new ECHARM_crystal_PbWO4();
    
    int vMillerX[3] = {h,k,l};    
    fCrystal->GetMiller()->SetX(vMillerX);
    
    fCrystal->SetTemperature(300.);
    ...
    fBRconst = new ECHARM_3vec(10. * meter,0.,0.);
...
ECHARM_StripPbWO4::~ECHARM_StripPbWO4(){
}
