...
ECHARM_EC_rec_eld_ax::ECHARM_EC_rec_eld_ax(ECHARM_crystal* crystal,
                                           int recX,
                                           int recY):
...
ECHARM_EC_rec_eld_ax::~ECHARM_EC_rec_eld_ax(){
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

bool ECHARM_EC_rec_eld_ax::GetIndexesSF(int* vIndex,int i0,int i1,int){
...
bool ECHARM_EC_rec_eld_ax::GetIndexesEC(double* vIndexEC,int* vIndexSF,int i0,int i1,int){
    if(fCrystal->GetMiller()->IsMainAxis()){
        vIndexEC[0] = i0;
        vIndexEC[1] = i1;
        return true;
