...
ECHARM_STLHC_UA9SIM::ECHARM_STLHC_UA9SIM(){
    ...
    fDim = new ECHARM_3vec(1. * millimeter,55. * millimeter,4. * millimeter);;
    fBRconst = new ECHARM_3vec(80. * meter,0.,0.);
    
    SetName("STLHC_UA9SIM");
}
