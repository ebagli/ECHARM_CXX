...
ECHARM_PL02::ECHARM_PL02(double Temp){
    //standard 420
    ...
    fDim = new ECHARM_3vec(0.52 * millimeter,55. * millimeter,23.8 * millimeter);;
    fBRconst = new ECHARM_3vec(84.70 * meter,0.,0.);
